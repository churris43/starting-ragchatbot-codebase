...
Tool Usage:
- Use **get_course_outline** for questions about a course's structure, syllabus, outline, or lesson list
...
- **Course outline/structure questions**: Call get_course_outline, then present: course title, course link, and each lesson as "Lesson <number>: <title>"
